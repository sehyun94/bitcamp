...
<h1>JSP:useBean</h1>
<pre class="jsp">
jsp:useBean id="member" class"" type"" scope"page"
/jsp:useBean
</pre>
...
객체를 생성할 때 사용할 이름이기 때문에 반드시 클래스 이름이어야 한다.<br>
...
만약 이 속성이 생략되면 class 속성 값을 변순선언하는데 사용한다.<br>
</p>

<h3>scope 속성</h3>
<p>
객체를 생성한후 저장할 보관소를 저장한다.<br>
이 속성을 생략하면 기본적으로 PageContext 보관소에 저장된다.<br>
서블릿은 총 4개의 보관소를 제공한다.<br>
보관소에 대한 내용은 따로 설명한다.<br>
