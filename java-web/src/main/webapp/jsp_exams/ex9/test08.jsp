...
<%--
<c:forEach var="변수명" items="EL 로 가져온 목록" begin="시작인덱스" end="끝인덱스">
....
</c:forEach>

목록으로 올 수 있는 값?
    - 배열
    - java.util.Collection, 예)ArrayList, LinkedList, Vector, EnumSet등
    - java.util.Iterator
    - java.util.Enumeration
    - java.util.Map
 --%>
<%
pageContext.setAttribute("list1", new String[]{"횽길동", "유관순", 
        "임꺽정", "윤봉길", "김구"});
%>
<p> 배열:
