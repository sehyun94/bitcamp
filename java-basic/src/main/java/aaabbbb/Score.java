...
public class Score {  
    ...
    public void print() {
        System.out.printf("이름:%-4s  합계:%4d  평균:%6.1f\n",  
                this.name, 
                this.sum, 
                this.aver);
    }
    public void printDetail() {
        System.out.printf("이름:%-4s 국어: %d 수학: %d 영어: %d  합계:%4d  평균:%6.1f\n",  
                this.name, 
                this.subjects[0],
                this.subjects[1],
                this.subjects[2],
    ...
    public void update() {
        ...
        System.out.printf("영어?(%s)?", this.subjects[1]);
        int eng = this.subjects[1];
        try {
            eng = Integer.parseInt((keyScan.nextLine()));
        } catch(Exception e) {}
        
        System.out.printf("수학점수?(%s)", this.subjects[2]);
