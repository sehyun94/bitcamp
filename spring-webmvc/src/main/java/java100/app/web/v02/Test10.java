...
public class Test10 {
    ...
    // => HttpServletRequest , HttpServletResponse, HttpSession, HttpMethod
    // => InputStream, OutputStream , Reader , Writer
    // => HttpEntity, Map/Model/ModelMap, Error/BindingResult,
    // => SessionStatuts, 파라미터, 경로의 일부 추출 값 등
    
    // => 프론트 컨트롤러는 페이지 컨트롤러의 메서드(요청 핸들러)를 호출하기 전에
    //    그 메서드의 파라미터를 분석하여 원하는 값을 넘겨준다.
