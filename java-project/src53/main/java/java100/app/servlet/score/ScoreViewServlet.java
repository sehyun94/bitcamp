    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (score != null) {
                ...
                out.println("<div class='form-group row'>");
                out.println("<label class='col-sm-2 col-form-label col-form-label-sm' for='kor'>국어</label>");
                out.println("<div class='col-sm-10'>");
                ...
                out.println("<div class='form-group row'>");
                out.println("<label class='col-sm-2 col-form-label col-form-label-sm'for='eng'>영어</label>");
                out.println("<div class='col-sm-10'>");
                ...
                out.println("<div class='form-group row'>");
                out.println("<label class='col-sm-2 col-form-label col-form-label-sm' for='math'>수학</label>");
                out.println("<div class='col-sm-10'>");
                ...
                out.println("<div class='form-group row'>");
                out.println("<label class='col-sm-2 col-form-label col-form-label-sm'  for='sum'>합계</label>");
                out.println("<div class='col-sm-10'>");
