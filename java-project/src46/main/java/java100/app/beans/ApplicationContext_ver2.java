...
//
public class ApplicationContext_ver2 {
    ...
    public ApplicationContext_ver2() {} 

    public static void main(String[] args) {
        new ApplicationContext_ver2("./bin");
    }
    // 2) 생성자에서 프로퍼티 파일을 읽어서 
    //    등록된 클래스의 인스턴스를 생성한다.
    //
    public ApplicationContext_ver2(String classpath) {
