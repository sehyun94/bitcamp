...
%>
  ...
  <jsp:include page="/header.jsp"/>      
        ...
        value='<%=score.getMath()%>'> 
         ...
         <div class='form-group row'>
        <label class='col-sm-2 col-form-label col-form-label-sm' for='sum'>합계</label>
        <div class='col-sm-10'>
        <input class='form-control'  readonly id='sum' type='number' name='sum'
        value='<%=score.getSum()%>'>  
        </div>
        </div>
        ...
        <div class='col-sm-10'>
        <input class='form-control' readonly id='aver' type='number' name='aver'
        value='<%=score.getAver()%>'> 
        </div>
        </div>
